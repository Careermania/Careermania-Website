# Generated by Django 2.2 on 2020-08-19 13:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='location_of', to='account.Address')),
            ],
        ),
        migrations.CreateModel(
            name='Course',
            fields=[
                ...
                ('branch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='courses_of', to='account.Branch')),
            ],
        ),
        migrations.CreateModel(
            name='CoachingReview',
            fields=[
                ...
                ('coaching', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reviews_of', to='account.Coaching')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coaching', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='metadata_of', to='account.Coaching')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coaching', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='faculty_of', to='account.Coaching')),
            ],
        ),
        migrations.AddField(
            model_name='branch',
            name='coaching',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='branches', to='account.Coaching'),
        ),
        migrations.CreateModel(
            name='Batch',
            fields=[
                ...
                ('is_active', models.BooleanField(default=False)),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='batches_of', to='account.Course')),
                ('teacher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='teaches', to='account.CoachingFacultyMember')),
            ],
        ),
        migrations.AddField(
            model_name='address',
            name='branch',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='address_of', to='account.Branch'),
        ),
    ]
